...
# sum of  other colours
sum = sum(list(colours.values()))

# calculate the probability of the colour being RED
prob = val/sum

print(f"Therefore, the probability of the colour being RED is: {prob}")